...
<div id="wrapper">
 	...
 	<div class="grid-form">
 		...
 		<h3 id="forms-example" class="">View Account</h3>
 		<form action ="goAccount.jsp" >
  
  <div class="form-group">
    <label for="exampleInputPassword1">Account number</label>
    <input type="text" class="form-control" name="id" id="exampleInputPassword1" placeholder="Enter your account number">
  </div>
